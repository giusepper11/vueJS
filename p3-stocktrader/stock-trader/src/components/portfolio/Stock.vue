        ...
        <v-card>
            <v-container fill-heigth>
                ...
                <v-btn class="blue darken-3 white--text"
                       ...
                       @click="sellStock">{{insufficientQuantity? 'Insuficiente':'Vender'}}
                </v-btn>
            </v-container>
        </v-card>
    </v-flex>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions({sellStockAction: 'sellStock'}), //mapea a ação com outro nome para n ter conflito com metodo
            sellStock() {
                const order = {
