<template>
    <div id="app" class="container-fluid">
        ...
        <!--        &lt;!&ndash;        <transition name="fade" appear>&ndash;&gt;-->
        <!--        &lt;!&ndash;            <b-alert variant="info" show v-if="exibir">{{msg}}</b-alert>&ndash;&gt;-->
        <!--        &lt;!&ndash;        </transition>&ndash;&gt;-->

        <!--        &lt;!&ndash;        <transition name="slide" type="animation" appear>&ndash;&gt;-->
        <!--        &lt;!&ndash;            <b-alert variant="info" show v-show="exibir">{{msg}}</b-alert>&ndash;&gt;-->
        <!--        &lt;!&ndash;        </transition>&ndash;&gt;-->

        <!--        &lt;!&ndash;        <transition enter-active-class="animated bounce" leave-active-class="animated shake">&ndash;&gt;-->
        <!--        &lt;!&ndash;            <b-alert variant="info" show v-show="exibir">{{msg}}</b-alert>&ndash;&gt;-->
        <!--        &lt;!&ndash;        </transition>&ndash;&gt;-->
        <!--        <hr>-->
        ...
        <!--        </transition>-->
        <!--        <hr>-->
        <!--        <b-button variant="primary" class="m-4" @click="componenteSelecionado='AlertaInfo'">Info</b-button>-->
        <!--        <b-button variant="secundary" class="m-4" @click="componenteSelecionado='AlertaAdvertencia'">Advertencia-->
        <!--        </b-button>-->
    ...
    export default {
        data() {
            return {
                ...
                msg: 'Uma messagem de informação para usuario',
                exibir: false,
                exibir2: true,
                tipoAnimacao: 'fade',
                larguraBase: 0,
