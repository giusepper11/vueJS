...
<script>
    import trataStringMixin from "../trataStringMixin";

	export default {
        data() {
            return {
                frase: 'Ola bom dia tudo bem ?',
                frase2: "Bom dia amigos"
            }
        },
		mixins : [trataStringMixin]
